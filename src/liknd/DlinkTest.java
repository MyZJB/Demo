...
public class DlinkTest {
    ...
    private static void int_test(){
        ...
        dlink.appendLast(10); //将10追加到链表未尾
        dlink.insertFirst(30); //将30插入到第一个位置
    ...
    private static void string_test(){
        ...
        dlink.insert(0,sarr[1]); //将sarr中第2个元素 插入到第一个位置
        dlink.appendLast(sarr[0]);  //将sarr中第一个元素 追加到链表未尾
        dlink.insertFirst(sarr[2]); //将sarr中第三个元素 插入到第一个位置
    ...
    private static void object_test(){
        ...
        dlink.insert(0,students[1]); //将students种的第2个元素 插入到第一个位置
        dlink.appendLast(students[0]); //将students中的第一个元素 追加到链表未尾
        dlink.insertFirst(students[2]); //将students中的第三个元素 插入到第一个位置
    ...
    public static void main(String[] args) {
        int_test(); //演示向双向链表操作"int"数据
        string_test(); //演示向双向链表操作"字符串数据"
        object_test(); //演示双向链表操作"对象"。
    }
}
